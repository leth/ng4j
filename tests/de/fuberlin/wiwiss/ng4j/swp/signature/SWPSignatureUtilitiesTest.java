...
public class SWPSignatureUtilitiesTest extends TestCase 
{
	 ...
	 */
	public void testCalculateDigestNamedGraphNode() throws SWPNoSuchDigestMethodException 
	{
		String digest1 = SWPSignatureUtilities.calculateDigest( g1, SWP.JjcRdfC14N_sha1.asNode() );
		String digest2 = SWPSignatureUtilities.calculateDigest( g1, SWP.JjcRdfC14N_sha1.asNode() );
		String digest3 = SWPSignatureUtilities.calculateDigest( g2, SWP.JjcRdfC14N_sha1.asNode() );
		String digest4 = SWPSignatureUtilities.calculateDigest( g2, SWP.JjcRdfC14N_sha1.asNode() );
	 ...
	 */
	public void testCalculateDigestNamedGraphSetNode() throws SWPNoSuchDigestMethodException 
	{
		String digest1 = SWPSignatureUtilities.calculateDigest( this.set, SWP.JjcRdfC14N_sha1.asNode() );
		System.out.println(digest1);
		String digest2 = SWPSignatureUtilities.calculateDigest( this.set, SWP.JjcRdfC14N_sha1.asNode() );
	 ...
	 */
	public void testCalculateSignatureNamedGraphNodePrivateKey() throws SWPInvalidKeyException, SWPSignatureException, SWPNoSuchAlgorithmException, SWPValidationException 
	{
		g1signature = SWPSignatureUtilities.calculateSignature( g1, SWP.JjcRdfC14N_rsa_sha1.asNode(), PKCS12Utils.decryptPrivateKey( keystore, password ) );
	 ...
	 */
	public void testCalculateSignatureNamedGraphSetNodePrivateKey() throws SWPInvalidKeyException, SWPSignatureException, SWPNoSuchAlgorithmException, SWPValidationException 
	{
		setSignature = SWPSignatureUtilities.calculateSignature( this.set, SWP.JjcRdfC14N_rsa_sha1.asNode(), PKCS12Utils.decryptPrivateKey( keystore, password ) );
		testValidateSignatureNamedGraphNodeStringString();
	}
	 ...
	 */
	public void testValidateSignatureNamedGraphNodeStringString() throws SWPInvalidKeyException, SWPSignatureException, SWPNoSuchAlgorithmException, SWPValidationException 
	{
		assertTrue( SWPSignatureUtilities.validateSignature( g1, SWP.JjcRdfC14N_rsa_sha1.asNode(), g1signature, (X509Certificate)PKCS12Utils.getCertChain( keystore, password )[0] ) );
	}
