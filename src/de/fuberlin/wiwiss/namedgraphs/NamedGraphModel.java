// $Id: NamedGraphModel.java,v 1.1 2004/09/13 14:37:24 cyganiak Exp $
...
public class NamedGraphModel extends ModelCom implements Model {
	...
	public Model write(OutputStream writer, String lang, String base) {
		// TODO: All write stuff still quite hacky, clean up!
		if ("TRIX".equals(lang)) {
			new NamedGraphSetWriter().write(this.graphSet, writer);
			return this;
		}
